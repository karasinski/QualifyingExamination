...
\newcommand\topsp{-0.25in} %standard spacing to remove between title and body
...
% \begin{frame}[fragile]{Thorndike}
% \begin{figure}[h!]
%     \begin{center}
%         \includegraphics[height=8cm]{../img/thorndike.png}
%         % \caption{}
%         % \label{}
%     \end{center}
% \end{figure}
...
\begin{frame}[fragile]{Thorndike, 1927~\cite{thorndike1927law}}
  \begin{columns}[T]
    \begin{column}{.6\textwidth}
      \begin{itemize}
        \setlength\itemsep{1em}
        % \item Thorndike's line-drawing experiment, 1927~\cite{thorndike1927law}
