...
Subjects were then asked to inspect four ``damaged'' points on the solar array, and were given a guidance display for navigation to the waypoints. %, see Figure~\ref{fig:displays}.
